...
SRC= 	ft_atoi.c	ft_isascii.c	ft_memcmp.c	ft_putendl_fd.c	ft_striteri.c	ft_strmapi.c	ft_substr.c \
	...
	ft_isalnum.c	ft_itoa.c	ft_memset.c	ft_strchr.c	ft_strlcpy.c	ft_strrchr.c \
